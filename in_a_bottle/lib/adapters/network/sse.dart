...
class EventSource {
  ...
  late Duration initialReconnectDelay;
  ...
  void _reconnect() {
    ...
    var _rec = _reconnectDelay!;
    _reconnecting = Timer(_rec, () {
      _reconnecting = null;
      if (_readyState == CLOSED) {
        open().catchError((err) {
          _reconnect();
    ...
    _rec *= 1.5 + _random.nextDouble();
    if (_rec > maxReconnectDelay) {
  ...
  void _onMessage(String message) {
    if (message == '') {
      ...
      _streamController.sink.add(MessageEvent(
